void SpawnWillowisp()
{
	...
	{
		Get_ab_WillowispManager().CreateRandomWillowispController("Veresnik Military Base", "4537.540039 318.433014 8297.910156", 500, 50 Math.RandomIntInclusive(1, 3));
	}
	
	if (Math.RandomFloat01() < chance)
	{
	    Get_ab_WillowispManager().CreateRandomWillowispController("Tisy Military Base", "452.923 421.686 11170.3", 500, 50 Math.RandomIntInclusive(1, 2));
	}
}
